                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="btn--container justify-content-end mt-3">
                            ...
                            @php
                                $days_diff = \Carbon\Carbon::now()->diffInDays($store?->store_sub_update_application?->expiry_date_parsed?->format('Y-m-d'), false);
                            @endphp
                            <button type="button"  data-url="{{route('admin.business-settings.subscriptionackage.cancelSubscription',$store?->id)}}" data-message="{{translate('If_you_cancel_the_subscription,_after_')}} {{ $days_diff }} {{ translate('days_the_vendor_will_no_longer_be_able_to_run_the_business_before_subscribe_a_new_plan.') }}"
